...
interface ThemeSelectorProps {
  currentVariant: "default" | "aurora" | "night" | "geometric" | "nebula"
  onVariantChange: (variant: "default" | "aurora" | "night" | "geometric" | "nebula") => void
...
export const ThemeSelector = ({ 
  ...
  const themeBgMap: Record<string, string> = {
    default: "bg-gradient-to-br from-blue-900/80 via-cyan-900/80 to-teal-900/80",
    aurora: "bg-gradient-to-br from-green-900/80 via-blue-900/80 to-emerald-900/80",
    geometric: "bg-gradient-to-br from-red-900/80 via-orange-900/80 to-yellow-900/80",
    nebula: "bg-gradient-to-br from-purple-900/80 via-pink-900/80 to-violet-900/80",
  ...
  const handleRandomTheme = () => {
    ...
    onVariantChange(randomVariant.value as any);
  };
      ...
      >
        ...
        <AnimatePresence>
          {showVariantSelector && (
            ...
            >
              <Card className={`${themeBgMap[currentVariant]} backdrop-blur-xl border border-slate-700/50 shadow-2xl`}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className={`font-semibold flex items-center ${themeTextColorMap[currentVariant]}`}>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className={`font-medium text-sm ${themeTextColorMap[currentVariant]}`}>
                                {variant.name}
                              </div>
                              <div className={`text-xs ${themeTextColorMap[currentVariant]}/70`}>
                                {variant.description}
                              </div>
                            </div>
                          </div>
